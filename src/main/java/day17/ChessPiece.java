...
public enum ChessPiece {
    ...
    private String represitation;

    ChessPiece(double value, String represitation) {
        this.value = value;
        this.represitation = represitation;
    }
    ...
    public String getRepresitation() {
        return represitation;
    }
}
